...
<body>
		...
		<!-- 导航条 -->
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link" href="#">用户登录
    ...
    <div class="col-9" >
    <figure class="figure">
  <img src="images/lg01.jpg" class="figure-img img-fluid rounded" alt="..." width="1100">
  <figcaption class="figure-caption text-right">选保险就选仪定保险！</figcaption>
    ...
    <div class="jumbotron">
					<form>
						...
						<a href="useragreement.jsp">《仪定保险服务协议》</a></span>
						</div>
						<p></p>
